...
<head>
    ...
    <title>Booking Terms & Conditions | Company Name</title>
    <?php
            ...
            <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
                <div class="container pt-20 pb-20" id="book">
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="text-theme-colored2 font-36">Booking Terms & Conditions</h2>
                                <ol class="breadcrumb text-left mt-10 white">
                                    <li><a href="index.php">Home</a></li>
                                    <li><a href="terms-conditions.php" class="active">Booking Terms & Conditions</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
