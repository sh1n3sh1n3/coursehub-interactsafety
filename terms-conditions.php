...
function get_interact_safety_terms() {
    ...
    ?>
<div class="content">
    <h3 class="text-theme-colored2 mt-0">Training Terms and Conditions</h3>
    ...
    <p>A place in a course is only confirmed once full payment has been successfully received and processed.</p>
    ...
    <p>It is the student's responsibility to provide accurate contact details at the time of booking.</p>

    <h4 class="mt-30 mb-10">4. Attendance and Participation Requirements</h4>
    <p>Students are required to attend the full duration of the course and actively participate in all required learning and assessment activities.</p>
    <p>Attendance and participation are required to meet WorkSafe Victoria training and certification requirements.</p>
    ...
    <h4 class="mt-30 mb-10">6. Cancellations, Transfers and Non-Attendance</h4>
    ...
    <p>Failure to attend scheduled training without prior notice may result in forfeiture of course fees.</p>
    <p>Interact Safety reserves the right to notify the participant's nominated workplace contact of non-attendance.</p>
    ...
    <p>Interact Safety collects and stores student information for the purpose of course administration, communication, certification, and compliance with relevant training and regulatory requirements.</p>
    <p>This includes information required for WorkSafe Victoria reporting, training records, and associated compliance obligations.</p>
    <p>Personal information will be handled in accordance with applicable privacy laws and will not be disclosed to third parties except where required for certification, compliance, or legal purposes.</p>

    <h4 class="mt-30 mb-10">11. Workplace Contact and Employer Communication</h4>
    <p>Where a workplace contact is provided during enrolment, Interact Safety may communicate with that contact regarding course attendance, participation, completion status, and certification outcomes.</p>
    <p>This may include notification of non-attendance, incomplete participation, or administrative follow-up required to meet course requirements.</p>
    <p>By enrolling, the participant confirms that they have authority to provide these contact details for this purpose.</p>

    <h4 class="mt-30 mb-10">12. Limitation of Liability</h4>
    ...
    <h4 class="mt-30 mb-10">13. Course Participation Responsibility</h4>
    <p>Participants are responsible for ensuring they are available to attend all scheduled training sessions and meet course requirements.</p>
    <p>Interact Safety is not responsible for missed sessions due to personal, workplace, or external factors.</p>

    <h4 class="mt-30 mb-10">14. Acceptance of Terms</h4>
