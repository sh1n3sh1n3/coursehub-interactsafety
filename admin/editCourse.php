                    ...
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
							...
							if(isset($_POST['submit'])) {
								...
								$aliascoursename = mysqli_real_escape_string($conn, $_POST['title']);;//mysqli_real_escape_string($conn, $_POST['aliascoursename']);
						...
						$testimonial = $conn->query("SELECT * FROM courses WHERE id=".$_GET['id'])->fetch_assoc();
						?>
                        ...
                        <div class="ibox-content">
							...
							<input type="hidden" name="id" value="<?php echo $testimonial['id']; ?>"/>
								<div class="form-group  row">
									...
									<div class="col-sm-4">
										<select class="form-control" required name="category">
											...
											<option value="<?php echo $fetch['id']; ?>" <?php if($testimonial['catid'] == $fetch['id']) {echo 'selected';} ?>><?php echo $fetch['title']; ?></option>
											<?php } ?>
										</select>
									</div>
									...
									<div class="col-sm-4">
										<select class="form-control" required name="course_type">
											<option value="">Select</option>
											<option value="Public" <?php if($testimonial['course_type'] == 'Public') {echo 'selected';} ?>>Public</option>
											<option value="Private" <?php if($testimonial['course_type'] == 'Private') {echo 'selected';} ?>>Private</option>
										</select>
									</div>
                                </div>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Course Duration </label>
                                    <div class="col-sm-4"><input type="number" class="form-control" required name="duration" value="<?php echo $testimonial['duration']; ?>"></div>
                                <label class="col-sm-2 col-form-label">Type</label>
                                    <div class="col-sm-4"><select class="form-control" required name="duration_type">
                                        <option value="">Select</option>
                                        <option value="Days" <?php if($testimonial['duration_type'] == 'Days') {echo 'selected';} ?>>Days</option>
                                        <option value="Hours" <?php if($testimonial['duration_type'] == 'Hours') {echo 'selected';} ?>>Hours</option>
                                    </select></div>
                                </div>
                                <div class="hr-line-dashed"></div>            
                                <div class="form-group  row">
                                <label class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-1"><img src="../assets/images/course/<?php echo $testimonial['image']; ?>" style="width:75px;height:75px;"/></div>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Short Description</label>
                                    <div class="col-sm-10"><textarea class="form-control ckeditor" name="shortdescription"><?php echo $testimonial['shortdescription']; ?></textarea></div>
                                </div>
								<!--<div class="hr-line-dashed"></div>-->
