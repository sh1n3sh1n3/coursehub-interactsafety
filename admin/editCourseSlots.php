                                ...
                                <form method="post" enctype="multipart/form-data" action="">
                                    ...
                                    <div class="form-group  row">
                                        ...
                                        <div class="radio inline" style="padding-top: 6px;">
                                            <input type="radio" onclick="checktype(this.value)" disabled id="Public" value="public" <?php if ($testimonial['type'] == 'public') {
                                                                                                                                        echo 'checked';
                                                                                                                                    } ?>>
                                            <label for="Public"> Public </label>
                                        </div>
                                        <div class="radio inline ml-3" style="padding-top: 6px;">
                                            <input type="radio" onclick="checktype(this.value)" disabled id="Private" value="private" <?php if ($testimonial['type'] == 'private') {
                                                                                                                                            echo 'checked';
                                                                                                                                        } ?>>
                                    ...
                                    <div class="form-group clientDiv row" id="clientDiv" style="display:<?php if ($testimonial['type'] == 'public') {
                                                                                                            echo 'none';
                                                                                                        } else {
                                                                                                            echo 'flex';
                                                                                                        } ?>">
                                    ...
                                    <div class="hr-line-dashed clientDiv" style="display:<?php if ($testimonial['type'] == 'public') {
                                                                                                echo 'none';
                                                                                            } else {
                                                                                                echo 'flex';
                                                                                            } ?>"></div>
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" required name="courseid">
                                                ...
                                                while ($fetch = $contact->fetch_assoc()) {
                                                    $count++; ?>
                                                    <option value="<?php echo $fetch['id']; ?>" <?php if ($testimonial['courseid'] == $fetch['id']) {
                                                                                                    echo 'selected';
                                                                                                } ?>><?php echo $fetch['title']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <label class="col-sm-2 col-form-label">Add Teacher</label>
                                        <div class="col-sm-4">
                                            <select class="form-control select" <?php if (!empty($teachers_id)) {
                                                                                } else {
                                                                                    echo 'required';
                                                                                } ?> name="teacherid[]" multiple>
                                                <option value="">Select</option>
                                                <?php $count = 0;
                                                ...
                                                while ($fetchers = $Eteachers->fetch_assoc()) {
                                                    $count++; ?>
                                    ...
                                    <div class="form-group  row">
                                        ...
                                        <div class="col-sm-4">
                                            <select class="form-control" required name="locid" onchange="getdata(this.value)">
                                                ...
                                                while ($fetch = $contact->fetch_assoc()) {
                                                    $count++; ?>
                                                    <option value="<?php echo $fetch['id']; ?>" <?php if ($testimonial['locid'] == $fetch['id']) {
                                                                                                    echo 'selected';
                                                                                                } ?>><?php echo $fetch['title']; ?></option>
                                                <?php } ?>
                                            </select>
