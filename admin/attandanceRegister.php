    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Register Course Attendance</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.php">Home</a>
                        </li>
                        <li class="breadcrumb-item active">
                            <strong>Register Course Attendance</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-title" style="padding:0">
                                <h5 style="float:left;width: auto;padding: 15px 0 8px 15px;">Register Course Attendance</h5>
                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                <div class="col-lg-4 row">
                                                    ...
                                                    <div class="col-sm-10"><select class="form-control" required name="course" id="course" onchange="getteachers(this.value)">
                                                ...
                                                <div class="col-lg-3 row">
                                                    ...
                                                    <div class="col-sm-10"><select class="form-control" required name="teacher" id="teacher" onchange="gettiming(this.value)">
                                                            <option value="">Select</option>
                                                        </select></div>
                                                </div>
                                                <div class="col-lg-4 row">
                                                    <label class="col-sm-3 pl-0 pr-0 col-form-label">Course Slot</label>
                                                    <div class="col-sm-9"><select class="form-control" required name="dates" id="dates">
                                                            <option value="">Select</option>
                                                        </select></div>
                                                </div>
