                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
								if (file_exists("../assets/images/clients/" . $pic)) {
									return false;
								} else {
									return true;
								}
                    					 ...
                    					 if (in_array($file_extension, $validextensions)) {
                    						 if ($_FILES["image"]["error"] > 0){
                    							...
                    							$up=0;
                    							  ...
                    							  $targetPath = "../assets/images/clients/".$image; // Target path where file is to be stored
							...
							$insert = $conn->query("INSERT INTO clients (title,image) VALUES('".$title."','".$image."')");
							if($insert){
