                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
							...
							$insert = $conn->query("UPDATE services SET title= '".$title."',catid= '".$category."',slug= '".$slug."',description= '".$description."', image= '".$image."' , updated='".date('Y-m-d')."' WHERE id=".$id);
							if($insert){
						...
						$testimonial = $conn->query("SELECT * FROM services WHERE id=".$_GET['id'])->fetch_assoc();
						?>
                        ...
                        <div class="ibox-content">
							...
							<div class="form-group  row">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-1"><img src="../assets/images/services/<?php echo $testimonial['image']; ?>" style="width:75px;height:75px;"/></div>
