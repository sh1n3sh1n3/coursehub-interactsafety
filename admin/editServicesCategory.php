            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
							<a href="servicescategory.php">Services Category</a>
                        </li>
                        <li class="breadcrumb-item active">
                            <strong>Edit Services  Category</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
							...
							$insert = $conn->query("UPDATE services_category SET title= '".$title."', showHome= '".$showHome."', slug= '".$slug."', image= '".$image."' WHERE id=".$id);
							if($insert){
						...
						$testimonial = $conn->query("SELECT * FROM services_category WHERE id=".$_GET['id'])->fetch_assoc();
						?>
