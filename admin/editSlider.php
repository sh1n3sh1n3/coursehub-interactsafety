                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						if(isset($_POST['submit'])) {
							...
							$insert = $conn->query("UPDATE slider SET link = '".$link."',image = '".$image."' WHERE id=".$_POST['id']);
							if($insert){
						...
						$about = $conn->query("SELECT * FROM slider WHERE id=".$_GET['id'])->fetch_assoc();
						?>
						
                        <div class="ibox-content">
                            <form method="post" enctype="multipart/form-data">                                
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-1"><a target="_blank" href="../assets/images/slider/<?php echo $about['image']; ?>"><img src="../assets/images/slider/<?php echo $about['image']; ?>" style="width:75px;height:75px;"/></a></div>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Link</label>
                                    <div class="col-sm-10"><input type="text" required class="form-control" name="link" value="<?php echo $about['link']; ?>"/></div>
                                </div>
                                <div class="hr-line-dashed"></div>
