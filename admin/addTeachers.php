                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
							...
							$insert = $conn->query("INSERT INTO teachers (title,slug,description,image,status,addedby, email, mobile, password, pass1, qualification) VALUES('".$title."','".$slug."','".$description."','".$image."','1','".$_SESSION['admin']."', '".$email."', '".$mobile."', '".$password."', '".$pass1."', '".$qualification."')");
							if($insert){
                        ...
                        <div class="ibox-content">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Mobile</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" required name="mobile" value=""></div>
                                </div>
                                <div class="hr-line-dashed"></div>                 
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Password</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" required name="password" value=""></div>
                                </div>
                                <div class="hr-line-dashed"></div>  
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Qualification</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" required name="qualification" value=""></div>
                                </div>
                                <div class="hr-line-dashed"></div>                                   
