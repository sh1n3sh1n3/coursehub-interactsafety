                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Edit News & Notifications</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
							...
							$insert = $conn->query("UPDATE news SET title= '".$title."',link= '".$link."',newsdate= '".$newsdate."', filename= '".$image."' WHERE id=".$id);
							if($insert){
						...
						$testimonial = $conn->query("SELECT * FROM news WHERE id=".$_GET['id'])->fetch_assoc();
						?>
                        ...
                        <div class="ibox-content">
							...
							<input type="hidden" name="id" value="<?php echo $testimonial['id']; ?>"/>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Link</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" name="link" value="<?php echo $testimonial['link']; ?>"></div>
                                </div>
								<div class="hr-line-dashed"></div>
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">News Date</label>
                                    <div class="col-sm-10"><input type="date" class="form-control" required name="newsdate" value="<?php echo $testimonial['newsdate']; ?>"></div>
                                </div>
                                <div class="hr-line-dashed"></div>                       
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-1"><img src="../images/news/<?php echo $testimonial['filename']; ?>" style="width:75px;height:75px;"/></div>
									<input type="hidden" name="oldimg" value="<?php echo $testimonial['filename']; ?>"/>
									<div class="col-sm-9">
