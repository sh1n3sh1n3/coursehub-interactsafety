                ...
                <div class="ibox ">
                    ...
                    <div class="ibox-content">
                        <div class="table-responsive">
							...
							<tr>
								<th>Sr. No.</th>
								<th>WorkSafe approved provider</th>
								<th>Form Submitted by</th>
								<th>Submission date</th>
								<th>Participant fullname</th>
								<th>HSR initial course start date</th>
								<th>Days missed</th>
								<th>Expected date to complete the course</th>
								<th>Reason</th>
							</tr>
							</thead>
							<tbody id="tablebody">
							<?php $count=0;
							$contact = $conn->query("SELECT * FROM extension_form order by id desc");
