                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
								if (file_exists("../assets/images/about/" . $pic)) {
									return false;
								} else {
									return true;
								}
						...
						if(isset($_POST['submit'])) {
										 ...
										 if (in_array($file_extension, $validextensions)) {
											 if ($_FILES["image"]["error"] > 0){
												...
												$up=0;
												  ...
												  $targetPath = "../assets/images/about/".$image; // Target path where file is to be stored
							...
							$insert = $conn->query("UPDATE aboutus SET image = '".$image."', description = '".$description."' WHERE id='1'");
							if($insert){
						...
						$about = $conn->query("SELECT * FROM aboutus WHERE id='1'")->fetch_assoc();
						?>
						
                        <div class="ibox-content">
                            <form method="post" enctype="multipart/form-data" action="about.php">                                
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Image</label>
                                    <div class="col-sm-1"><a target="_blank" href="../assets/images/about/<?php echo $about['image']; ?>"><img src="../assets/images/about/<?php echo $about['image']; ?>" style="width:75px;height:75px;"/></a></div>
                                ...
                                <div class="form-group  row"><label class="col-sm-2 col-form-label">Description</label>
                                    <div class="col-sm-10"><textarea class="form-control ckeditor" name="content" rows="10"><?php echo $about['description']; ?></textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
