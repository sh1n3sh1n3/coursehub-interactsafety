                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="courses.php">Registered Courses</a>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 row">
                                                    <label class="col-sm-3 col-form-label" style="white-space: nowrap;">Delivery Method</label>
                                                    <div class="col-sm-9">
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?php if ($fetch['status'] == '1') {
                                                            echo '<span class="mb-1 label label-primary">Active</span>';
                                                        } else {
                                                            echo '<span class="mb-1 label label-default">Not Active</span>';
                                                        } ?><br>
                                                        <?php if ($fetch['isPublished'] == '1') {
                                                            echo '<span class="mb-1 label label-success">Published</span>';
                                                        } else {
                                                            echo '<span class="mb-1 label label-info">Not Published</span>';
                                                        } ?></td>
                                                    ...
                                                    <!--</td>-->
                                                    <td>
                                                        <a href="editCourse.php?id=<?php echo $fetch['id']; ?>" class="mb-1 btn btn-white btn-sm"><i class="fa fa-pencil"></i> Edit </a>
