		...
		<ul class="nav metismenu" id="side-menu">
				...
				<ul class="nav nav-second-level collapse">
					...
					<li class="<?= (($activePage == 'addLocations') || ($activePage == 'locations') || ($activePage == 'editLocations')) ? 'active' : ''; ?>">
						...
						<ul class="nav nav-second-level collapse">
							...
							<li class="<?= (($activePage == 'locations') || ($activePage == 'checklist') || ($activePage == 'editLocations')) ? 'active' : ''; ?>"><a href="locations.php">Registered Locations</a></li>
						</ul>
					</li>
					<li class="<?= (($activePage == 'addIndustry') || ($activePage == 'industry') || ($activePage == 'editIndustry')) ? 'active' : ''; ?>">
						...
						<ul class="nav nav-second-level collapse">
							...
							<li class="<?= (($activePage == 'industry') || ($activePage == 'checklist') || ($activePage == 'editIndustry')) ? 'active' : ''; ?>"><a href="industry.php">Register Industries</a></li>
						</ul>
					</li>
				</ul>
			</li>
			...
			<li class="<?= (($activePage == 'course_detail') || ($activePage == 'addCourse') || ($activePage == 'courses') || ($activePage == 'editCourse')) ? 'active' : ''; ?>">
				...
				<ul class="nav nav-second-level collapse">
					...
					<li class="<?= (($activePage == 'courses') || ($activePage == 'editCourse')) ? 'active' : ''; ?>"><a href="courses.php">Registered Courses</a></li>
				</ul>
			</li>
			<li class="<?= (($activePage == 'courseslots') || ($activePage == 'addCourseSlots') || ($activePage == 'courseslots') || ($activePage == 'editCourseSlots')) ? 'active' : ''; ?>">
				...
				<ul class="nav nav-second-level collapse">
					...
					<li class="<?= (($activePage == 'courseslots') || ($activePage == 'editCourseSlots')) ? 'active' : ''; ?>"><a href="courseslots.php">Scheduled Courses</a></li>

				</ul>
			</li>
			<li class="<?= (($activePage == 'users') || ($activePage == 'courses-report') || ($activePage == 'scheduled-courses-report') || ($activePage == 'students-report') || ($activePage == 'courseHub') || ($activePage == 'courseScope') || ($activePage == 'attandanceRegister') || ($activePage == 'participantIndustry') || ($activePage == 'studentProfile') || ($activePage == 'courseDeivery')) ? 'active' : ''; ?>">
				<a href="#"><i class="fa fa-newspaper-o"></i> <span class="nav-label">Reports</span><span class="fa arrow"></span></a>
				<ul class="nav nav-second-level collapse">
					<li class="<?= (($activePage == 'courses-report') || ($activePage == 'scheduled-courses-report') || ($activePage == 'students-report')) ? 'active' : ''; ?>"><a href="courses-report.php">Course Report</a></li>
					<li class="<?= (($activePage == 'users')) ? 'active' : ''; ?>"><a href="users.php">Registered Students</a></li>
					<!-- <li  class="<?= (($activePage == 'attandanceRegister')) ? 'active' : ''; ?>"><a href="attandanceRegister.php">Registered Courses</a></li> -->
