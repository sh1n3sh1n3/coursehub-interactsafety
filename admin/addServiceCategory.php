            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
							<a href="servicecategory.php">Service Category</a>
                        </li>
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
							...
							$insert = $conn->query("INSERT INTO services_category (title,slug,image, showHome) VALUES ('".$title."','".$slug."','".$image."', '".$showHome."')");
							if($insert){
