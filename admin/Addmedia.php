                ...
                <div class="col-lg-12">
                    <div class="ibox ">
						...
						<?php function checkimg($pic){
								if (file_exists("../assets/images/media/" . $pic)) {
									return false;
								} else {
									return true;
								}
							...
							if(isset($_POST['submit'])) {
                    					 ...
                    					 if (in_array($file_extension, $validextensions)) {
                    						 if ($_FILES["image"]["error"] > 0){
                    							...
                    							$up=0;
                    							  ...
                    							  $targetPath = "../assets/images/media/".$image; // Target path where file is to be stored
                    			...
                    			$url = $domian.'/assets/images/media/'.$image;
							$insert = $conn->query("INSERT INTO media (title,image,url) VALUES('".$title."','".$image."','".$url."')");
							if($insert){
