...
<?php if (!empty($row)) {
    ...
    if ($seeltdata->num_rows > 0 || $saleCreatedNow) {
        ...
        if ($emailaccount['status'] == '1' && $saleCreatedNow) {
            ...
            $txt1 .= "<h3 style='margin-top:24px;'>Important Information for HSRs</h3>";
            $txt1 .= "<p>Under the Occupational Health and Safety Act 2004:</p>";
            $txt1 .= "<ul style='line-height:1.6;'>";
            $txt1 .= "<li>HSRs are entitled to attend approved training</li>";
            $txt1 .= "<li>HSRs have the right to choose their training course in consultation with their employer</li>";
            $txt1 .= "</ul>";
            $txt1 .= "<h3 style='margin-top:24px;'>Attendance Requirements</h3>";
            $txt1 .= "<ul style='line-height:1.6;'>";
            $txt1 .= "<li>Attendance is required across all scheduled sessions</li>";
            $txt1 .= "<li>Participation is expected throughout the course</li>";
            $txt1 .= "<li>Late arrival or missed sessions may impact course completion</li>";
            $txt1 .= "</ul>";
            $txt1 .= "<h3 style='margin-top:24px;'>What's Provided</h3>";
            $txt1 .= "<p>To support your learning, the following will be provided:</p>";
            $txt1 .= "<ul style='line-height:1.6;'>";
            $txt1 .= "<li>Training folder and course materials</li>";
            $txt1 .= "<li>Morning tea and lunch (sandwiches/wraps)</li>";
            $txt1 .= "<li>Tea and coffee</li>";
            $txt1 .= "</ul>";
            $txt1 .= "<p>If you prefer to bring your own lunch or explore other options, there are a variety of cafes and shops located nearby. A fridge is also available for your use.</p>";
            $txt1 .= "<h3 style='margin-top:24px;'>What to Bring</h3>";
            $txt1 .= "<ul style='line-height:1.6;'>";
            $txt1 .= "<li>Pens (highlighters optional)</li>";
            $txt1 .= "<li>Water bottle (optional)</li>";
            $txt1 .= "</ul>";
            $txt1 .= "<h3 style='margin-top:24px;'>Need Help?</h3>";
            $txt1 .= "<p>If you have any questions or need to make changes to your booking:</p>";
            $txt1 .= "<ul style='line-height:1.6;'>";
            $txt1 .= "<li><strong>Email:</strong> <a href='mailto:info@interactsafety.com.au'>info@interactsafety.com.au</a></li>";
            $txt1 .= "</ul>";
            $txt1 .= "<h3 style='margin-top:24px;'>Final Note</h3>";
            $txt1 .= "<p>We look forward to working with you and supporting you in your role as a Health and Safety Representative.</p>";
            $txt1 .= "<p style='margin-top:24px;'>Regards,<br>Interact Safety Training Team</p>";
