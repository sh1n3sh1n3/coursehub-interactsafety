        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox ">
					...
					$contact = $conn->query("SELECT * FROM course_teachers WHERE teacherid='".$_SESSION['teacher']."' AND accepted='1' AND status='1' AND is_deleted='0' order by id DESC");
                    ...
                    <tr>
                        ...
                        <td>
							<a class="btn btn-warning btn-lg" data-toggle="modal" data-target="#qrModal<?php echo $fetdata['id']; ?>"><i class="fa fa-clock-o"></i> Open </a>
							<div id="qrModal<?php echo $fetdata['id']; ?>" class="modal fade" role="dialog">
                              <div class="modal-dialog modal-lg">
                            
                                <!-- Modal content-->
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h4 class="modal-title">QR Attendance</h4>
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                  </div>
                                  <div class="modal-body">
                                    <p><?php $filename = $PNG_TEMP_DIR.'test.png';
                                        ...
                                        $generated_code = $domian.'/markAttandance/'.encryptStringArray($fetdata["courseid"]).'/'.encryptStringArray($fetdata["locid"]).'/'.encryptStringArray($fetdata["id"]).'/'.encryptStringArray($fetteach["teacherid"]);
                                        ...
                                        echo '<center><img src="data:image/png;base64,'.$data.'" /></center>';?></p>
                                  </div>
                        ...
                        <td>
							<a class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal<?php echo $fetdata['id']; ?>"><i class="fa fa-eye"></i> View </a>
							<div id="myModal<?php echo $fetdata['id']; ?>" class="modal fade" role="dialog">
                              <div class="modal-dialog modal-lg">
						...
						<td><a title="Click to view orders" href="users.php?id=<?php echo $fetdata['id']; ?>" class="btn btn-info btn-sm"> View Course Attendance </a></td>
                    </tr>
					<?php } ?>
                    </tbody>
                    </table>
