...
$policy = $conn->query("SELECT * FROM policy WHERE id='3'")->fetch_assoc();
?>
<!DOCTYPE html>
            ...
            <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
                <div class="container pt-20 pb-20" id="book">
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="text-theme-colored2 font-36">Social Media Policy</h2>
                                <ol class="breadcrumb text-left mt-10 white">
                                    <li><a href="index.php">Home</a></li>
                                    	<li><a href="media-policy.php" class="active">Social Media Policy</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
